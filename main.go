...
//go:generate go run github.com/go-bindata/go-bindata/v3/go-bindata -nometadata -pkg templatebin -o templatebin/bindata.go templates templates/singleton templates_test templates_test/singleton
