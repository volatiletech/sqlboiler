...
func main() {
	...
	rootCmd.PersistentFlags().StringSliceP("ignore-fields", "", nil, "List of column names that should have tags values omitted")
...
func preRun(cmd *cobra.Command, args []string) error {
	...
	cmdConfig = &boilingcore.Config{
		...
		IgnoreFields:      viper.GetStringSlice("ignore-fields"),
