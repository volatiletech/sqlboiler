...
func templates17_upsertTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/17_upsert.tpl", size: 5563, mode: os.FileMode(420), modTime: time.Unix(1528524897, 0)}
...
func templates_testSingletonPsql_suites_testTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates_test/singleton/psql_suites_test.tpl", size: 255, mode: os.FileMode(420), modTime: time.Unix(1528525627, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templates_testUpsertTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates_test/upsert.tpl", size: 1726, mode: os.FileMode(420), modTime: time.Unix(1528525232, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
