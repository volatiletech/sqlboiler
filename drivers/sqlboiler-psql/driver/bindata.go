...
func templatesSingletonPsql_upsertTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/singleton/psql_upsert.tpl", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templates_testSingletonPsql_main_testTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates_test/singleton/psql_main_test.tpl", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templates_testSingletonPsql_suites_testTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates_test/singleton/psql_suites_test.tpl", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
